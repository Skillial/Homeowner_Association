<%-- Document : register_processing Created on : 04 14, 23, 2:30:32 PM Author : ccslearner --%>
                ...
                <div class="container" style>
                    <div class="rectangle" style="padding: 5px">
                        ...
                        <% String v_asset_name=request.getParameter("asset_name"); String
                            ...
                            (v_for_rent!=null){ A.for_rent="1" ; } else{ A.for_rent="0" ; } A.asset_value=v_asset_value;
                            A.type_asset=v_type_asset; A.status=v_status; A.loc_lat=v_loc_lat; A.loc_long=v_loc_long;
                            A.HOA_Name=v_HOA_Name; A.Enclosing_Asset=v_Enclosing_Asset; %>
                            <br><br><br><br><br><br><br><br><br>
                            <% int status=A.register_asset(); if (status==1){ %>

                                <h1 style="text-align: center">Registering Asset Successful</h1>
                                <% }else{ %>

                                    <h1 style="text-align: center; color: red">Registering Asset Failed</h1>
                                    <% } %>
                                        <br><br><br><br><br><br><br><br><br>
